        ...
        <div class="footer-container">
            ...
            <div class="footer-brand">
                <div class="logo">
                    <a href="${rp}index.html" style="display:flex;align-items:center;gap:0.6rem;text-decoration:none;">
                        <svg width="28" height="26" viewBox="0 0 100 88" fill="none" stroke="#1d6df2" stroke-width="6" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="4,52 50,10 96,52"/>
                            <polyline points="72,28 72,16 84,16 84,42"/>
                            <polyline points="17,52 17,82 83,82 83,52"/>
                        </svg>
                ...
                <div class="footer-social" style="margin-top:1.25rem;display:flex;gap:0.6rem;">
                    <a href="https://www.instagram.com/mnlakehomes/" target="_blank" rel="noopener" aria-label="MN Lake Homes on Instagram" style="display:inline-flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:8px;background:#f0f3f7;color:#4a5568;text-decoration:none;">
            ...
            <div class="footer-links">
                <div class="link-column">
                    <h4>Popular Lakes</h4>
                    <a href="/lakes/gull-lake">Gull Lake</a>
                    <a href="/lakes/lake-minnetonka">Lake Minnetonka</a>
                    <a href="/lakes/mille-lacs-lake">Mille Lacs</a>
                    <a href="/lakes/lake-vermilion">Lake Vermilion</a>
                    <a href="/lakes/whitefish-chain">Whitefish Chain</a>
                    <a href="/towns">All lakes &amp; towns</a>
                </div>
                <div class="link-column">
                    <h4>Real Estate</h4>
