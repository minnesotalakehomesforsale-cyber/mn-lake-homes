...
module.exports = [
    ...
    // ── Interactive tools (link out to the tool pages, not gated PDFs) ───
    {
        slug: 'find-your-lake-quiz',
        title: 'Find Your Lake Quiz',
        description: 'Answer four quick questions — budget, drive time, vibe, and priorities — and get matched to the Minnesota lakes that fit.',
        category: 'Tools',
        resource_type: 'Tool',
        url: '/find-your-lake',
        thumbnail_url: '/assets/images/mn-aerial-lake-homes.jpg',
        tags: ['tool', 'buyer', 'quiz'],
        featured: true,
    },
    {
        slug: 'compare-mn-lakes',
        title: 'Compare Minnesota Lakes',
        description: 'Put any Minnesota lakes side by side — price, drive time, size, vibe, and fishing.',
        category: 'Tools',
        resource_type: 'Tool',
        url: '/compare-lakes',
        thumbnail_url: '/assets/images/mn-purple-sunset-marina.webp',
        tags: ['tool', 'buyer', 'compare'],
    },
    {
        slug: 'lake-cost-calculator',
        title: 'Lake Home Cost Calculator',
        description: 'Estimate the real monthly cost of a lake home — principal, interest, taxes, and insurance — plus the lakefront costs buyers forget.',
        category: 'Tools',
        resource_type: 'Tool',
        url: '/lake-mortgage-calculator',
        thumbnail_url: '/assets/images/mn-cape-cod-lakefront.jpg',
        tags: ['tool', 'buyer', 'calculator'],
    },
    {
        slug: 'lake-buyer-checklist-tool',
        title: "Lake Home Buyer's Checklist",
        description: 'The interactive lake-home checklist — water, septic, docks, setbacks, access. Saves your progress and prints for showings.',
        category: 'Tools',
        resource_type: 'Tool',
        url: '/lake-buyer-checklist',
        thumbnail_url: '/assets/images/mn-canoe-shore.webp',
        tags: ['tool', 'buyer', 'checklist'],
    },
];
