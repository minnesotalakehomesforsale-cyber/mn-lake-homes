...
module.exports = {
  'alexandria':      { title: 'Alexandria MN Homes for Sale | Lakes Area Real Estate', description: 'Homes for sale in Alexandria, Minnesota — hub of the Alexandria chain of lakes (Carlos, Darling, Le Homme Dieu). Find lake and in-town homes with a local agent.' },
  ...
  'detroit-lakes':   { title: 'Detroit Lakes MN Homes for Sale | Lakes Area Real Estate', description: 'Homes for sale in Detroit Lakes, Minnesota — a classic resort town ringed by hundreds of lakes and a famous beach. Find lakefront homes with a local agent.' },
  ...
  'forest-lake':     { title: 'Forest Lake MN Homes for Sale | NE Metro Real Estate', description: 'Homes for sale in Forest Lake, Minnesota — a northeast-metro lake town with an easy Twin Cities commute. Find lake and in-town homes with a local agent.' },
  'grand-rapids':    { title: 'Grand Rapids MN Homes for Sale | Itasca Lakes Real Estate', description: 'Homes for sale in Grand Rapids, Minnesota — a north-woods town surrounded by lakes and forest, including Pokegama Lake. Find property with a local agent.' },
  'lino-lakes':      { title: 'Lino Lakes MN Homes for Sale | NE Metro Real Estate', description: 'Homes for sale in Lino Lakes, Minnesota — a growing northeast-metro suburb built around a chain of lakes and parkland. Find homes with a local agent.' },
