        ...
        tiers: [
            {
                tier: 'free',
                name: 'Free',
                tagline: 'Get listed on one lake page — no card required.',
                features: [
                    'Basic directory listing on one lake page',
                    'Credited backlink to your site',
                    'Bottom placement',
                ],
                monthly_price: 0,
                annual_price:  0,
                free: true,
                stripe_price_monthly: false,
                stripe_price_annual:  false,
            },
            {
                tier: 'basic',
                name: 'Standard',
                tagline: 'Enhanced listing on the lake pages you care about.',
                features: [
                    'Enhanced listing (logo, blurb, link) on up to 3 lake pages',
                    'Credited backlink',
                    'Mid placement',
                ],
            ...
            },
            {
                tier: 'premium',
                name: 'Premium',
                tagline: 'Featured at the top of every relevant lake page.',
                features: [
                    'Featured listing, top of category, on all relevant lake pages',
                    'Credited backlink',
                    'Top placement + cross-promo to our agents',
                ],
